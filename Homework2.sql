...
-- --------------------------------------------------------------------------------
-- +50% Extra credit Show all users that have at least 3 favorite songs by your
--                   number 1 favorite band and at least 3 songs by your second
--					 favorite band - show counts for each favorite band - this is
...
(SELECT 
	...
	,TU.strLastName
		+ ', '
		+ TU.strFirstName						AS strUser
	,COUNT(*)	AS intFavoriteBand1SongCount
	,0 AS intFavoriteBand2SongCount
FROM
	TUsers									AS TU
		INNER JOIN TUserFavoriteSongs		AS TUFS
			INNER JOIN TSongs				AS TS
...
SELECT 
	...
	+ ', '
	+ TU.strFirstName						AS strUser
	,0 AS intFavoriteBand1SongCount
	,COUNT(*)  AS intFavoriteBand2SongCount
FROM
	TUsers									AS TU
		INNER JOIN TUserFavoriteSongs		AS TUFS
			INNER JOIN TSongs				AS TS
